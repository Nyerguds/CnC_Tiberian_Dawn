...
* Added power balance info on the power output and building tooltips. This is enabled by default, but can be disabled with the option "PowerToolTips=false" in conquer.ini
