...
* Units in Sleep or Sticky mode will no longer try to crush nearby infantry.
...
* Oil Derricks preplaced on the map will now also get the flame spout animation if they're damaged below 50%.
